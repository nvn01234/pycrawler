...
class Scopus2017Document(models.Model):
    authors = models.TextField(null=True)
    title = models.TextField(null=True)
    year = models.TextField(null=True)
    source_title = models.TextField(null=True)
    ...
    class Meta:
        db_table = 'scopus_documents_2017'
        app_label = 'scopus_documents_2017'

class Isi2017Document(models.Model):
    abstract = models.TextField(null=True)
    address = models.TextField(null=True)
    affiliation = models.TextField(null=True)
    article_number = models.TextField(null=True)
    ...
    class Meta:
        db_table = 'isi_documents_2017'
        app_label = 'isi_documents_2017'